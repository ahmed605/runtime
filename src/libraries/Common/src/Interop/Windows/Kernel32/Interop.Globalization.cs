...
internal static partial class Interop
{
    internal static partial class Kernel32
    {
        ...
        [LibraryImport("kernelbase.dll", EntryPoint = "FindNLSStringEx", SetLastError = SetLastErrorForDebug)]
        ...
        [LibraryImport("kernelbase.dll", EntryPoint = "CompareStringEx")]
        ...
        [LibraryImport("kernelbase.dll", EntryPoint = "CompareStringOrdinal")]
        ...
        [LibraryImport("kernelbase.dll", EntryPoint = "FindStringOrdinal", SetLastError = SetLastErrorForDebug)]
        ...
        [LibraryImport("kernelbase.dll", EntryPoint = "GetGeoInfoW")]
