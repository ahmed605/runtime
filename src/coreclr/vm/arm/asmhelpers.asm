...
CallDescrWorkerInternalReturnAddressOffset
    EXPORT CallDescrWorkerInternalReturnAddressOffset
    DCD CallDescrWorkerInternalReturnAddress - C_FUNC(CallDescrWorkerInternal)
...
RedirectedHandledJITCaseFor$reason._StubEnd
        EXPORT RedirectedHandledJITCaseFor$reason._StubEnd
...
#define pShadow r7
    ...
    MACRO
    START_WRITE_BARRIER $name
        __$name.__g_lowest_address_offset SETA 0xffff
        __$name.__g_highest_address_offset SETA 0xffff
        __$name.__g_ephemeral_low_offset SETA 0xffff
        __$name.__g_ephemeral_high_offset SETA 0xffff
        __$name.__g_card_table_offset SETA 0xffff
#ifdef FEATURE_USE_SOFTWARE_WRITE_WATCH_FOR_GC_HEAP
        __$name.__g_sw_ww_table_offset SETA 0xffff
#endif
     MEND

    MACRO
    LOAD_GC_GLOBAL $name, $regName, $globalName
$name.__$globalName._offset
    __$name.__$globalName._offset SETA ($name.__$globalName._offset - $name)
        movw $regName, #0
        movt $regName, #0
    MEND

    MACRO
    UPDATE_GC_SHADOW $name, $ptrReg, $valReg
        ; Todo: implement, debugging helper
    MEND

    MACRO
    UPDATE_CARD_TABLE $name, $ptrReg, $valReg, $mp, $postGrow, $tmpReg

        LOAD_GC_GLOBAL $name, __wbScratch, g_ephemeral_low
        cmp $valReg, __wbScratch
        blo %FT0

    IF $postGrow != 0
            LOAD_GC_GLOBAL $name, __wbScratch, g_ephemeral_high
            cmp $valReg, __wbScratch
            bhs %FT0
    ENDIF

        LOAD_GC_GLOBAL $name, __wbScratch, g_card_table
...
#ifdef FEATURE_USE_SOFTWARE_WRITE_WATCH_FOR_GC_HEAP
    MACRO
    UPDATE_WRITE_WATCH_TABLE $name, $ptrReg, $mp, $tmpReg

        LOAD_GC_GLOBAL $name, __wbScratch, g_write_watch_table
        cbz __wbScratch, %FT2
...
2
    ...
    MACRO
    CHECK_GC_HEAP_RANGE $name, $ptrReg, $label
        LOAD_GC_GLOBAL $name, __wbScratch, g_lowest_address
        cmp $ptrReg, __wbScratch
        blo $label
        LOAD_GC_GLOBAL $name, __wbScratch, g_highest_address
        cmp $ptrReg, __wbScratch
        bhs $label
    MEND
    ...
    ENDIF
        ...
        str r1, [r0]
        UPDATE_GC_SHADOW $name, r0, r1
#ifdef FEATURE_USE_SOFTWARE_WRITE_WATCH_FOR_GC_HEAP
        UPDATE_WRITE_WATCH_TABLE $name, r0, $mp, r12
#endif
        UPDATE_CARD_TABLE $name, r0, r1, $mp, $post, r0
        bx lr
    LEAF_END_MARKED $name, _TEXT
    MEND
    ...
    LEAF_ENTRY $name, _TEXT
        START_WRITE_BARRIER $name
        str r1, [r0]
        CHECK_GC_HEAP_RANGE $name, r0, %FT1
        UPDATE_GC_SHADOW $name, r0, r1
#ifdef FEATURE_USE_SOFTWARE_WRITE_WATCH_FOR_GC_HEAP
        UPDATE_WRITE_WATCH_TABLE $name, r0, 0, r12
#endif
        UPDATE_CARD_TABLE $name, r0, r1, 0, $post, r0
1
        bx lr
    LEAF_END_MARKED $name, _TEXT
    MEND
    ...
    LEAF_ENTRY $name, _TEXT
        ...
        UPDATE_GC_SHADOW $name, r0, r1
#ifdef FEATURE_USE_SOFTWARE_WRITE_WATCH_FOR_GC_HEAP
        UPDATE_WRITE_WATCH_TABLE $name, r0, 1, r12
#endif
        UPDATE_CARD_TABLE $name, r0, r1, 1, $post, r0
        bx lr
1
        str r1, [r0]
        bx lr
    ...
    ENDIF
        ...
        str r2, [r0]
        CHECK_GC_HEAP_RANGE $name, r0, %FT1
        UPDATE_GC_SHADOW $name, r0, r2
#ifdef FEATURE_USE_SOFTWARE_WRITE_WATCH_FOR_GC_HEAP
        UPDATE_WRITE_WATCH_TABLE $name, r0, $mp, r12
#endif
        UPDATE_CARD_TABLE $name, r0, r2, $mp, $post, r2
1
        add r0, #4
        add r1, #4
        bx lr
    ...
    MACRO
    JIT_WRITEBARRIER_DESCRIPTOR $name
1
        DCD $name-1b
        DCD $name._End-1b
        DCD __$name.__g_lowest_address_offset
        DCD __$name.__g_highest_address_offset
        DCD __$name.__g_ephemeral_low_offset
        DCD __$name.__g_ephemeral_high_offset
        DCD __$name.__g_card_table_offset
#ifdef FEATURE_USE_SOFTWARE_WRITE_WATCH_FOR_GC_HEAP
        DCD __$name.__g_write_watch_table_offset
#endif
    MEND
...
DelayLoad_Helper$suffix
        EXPORT DelayLoad_Helper$suffix
