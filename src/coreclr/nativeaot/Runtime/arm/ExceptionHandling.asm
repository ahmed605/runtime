...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        ;; link the ExInfo into the thread's ExInfo chain
        ldr         r3, [r2, #OFFSETOF__Thread__m_pExInfoStackHead] ;; r3 <- currently active ExInfo
...
#define rsp_offset_r0 (8 * 8) + 0
#define rsp_offset_r2 (8 * 8) + 4
#define rsp_offset_r3 (8 * 8) + 8

        ;;
        ;; Clear the DoNotTriggerGc state before calling out to our managed catch funclet. Unlike the Unix
        ;; flavor the thread lookup is inline and does not trash the argument registers, so r0-r3 stay live
        ;; and only the (already saved) r5/r6 and r4 are used as scratch.
        ;;
...
DonePopping
        ...
        ldr         r0, [sp, #rsp_offset_r0]                    ;; reload the result

        ;; reset SP and jump to the continuation address
        mov         sp, r2
        bx          r0
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        mov         r12, r1                                 ;; r12 <- filter funclet address
        ;; r0 still contains the exception object
