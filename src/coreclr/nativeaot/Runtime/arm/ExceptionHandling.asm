...
#define STACKSIZEOF_ExInfo ((SIZEOF__ExInfo + 7):AND:(~7))
...
#define rsp_offsetof_Context STACKSIZEOF_ExInfo
	...
	;
	;////////////////////////////////////////////////////////////////////////////////////////////////////////////
	NESTED_ENTRY RhpThrowHwEx, NoHandler
	...
	;
	;////////////////////////////////////////////////////////////////////////////////////////////////////////////
	NESTED_ENTRY RhpThrowEx, NoHandler
...
NotHiJacked
	...
	;
	;////////////////////////////////////////////////////////////////////////////////////////////////////////////
	NESTED_ENTRY RhpRethrow, NoHandler
	...
	;
	;////////////////////////////////////////////////////////////////////////////////////////////////////////////
	NESTED_ENTRY RhpCallCatchFunclet, NoHandler
...
ClearSuccess_Catch
	...
	ALTERNATE_ENTRY RhpCallCatchFunclet2
			...
			INLINE_GETTHREAD r0, r1                          ; r0 <- Thread*
...
DonePopping
	...
	;
	;////////////////////////////////////////////////////////////////////////////////////////////////////////////
	NESTED_ENTRY RhpCallFinallyFunclet, NoHandler
	...
	#define rsp_offset_r1 8 * 8
			...
			;
			INLINE_GETTHREAD r0, r2  ; r0 <- Thread*
...
SetSuccess
	...
	;
	;////////////////////////////////////////////////////////////////////////////////////////////////////////////
	NESTED_ENTRY RhpCallFilterFunclet, NoHandler
