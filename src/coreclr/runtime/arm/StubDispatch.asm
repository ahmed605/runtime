...
StubName    SETS    "RhpInterfaceDispatch$entries"
	...
	NESTED_ENTRY $StubName, _TEXT
			...
			GBLA CurrentOffset
CurrentOffset SETA OFFSETOF__InterfaceDispatchCache__m_rgEntries
			...
			LCLA CurrentEntryLoop
CurrentEntryLoop SETA 0
			WHILE CurrentEntryLoop < $entries
				  ...
				  b          L99_$entries
0
CurrentOffset SETA CurrentOffset + 8
CurrentEntryLoop SETA CurrentEntryLoop + 1
			WEND
			...
			ldr         r1, [sp, #-8]
			ldr         r2, [sp, #-4]
			b.w           C_FUNC(RhpInterfaceDispatchSlow)
...
L99_$entries
    ...
    MEND ; DEFINE_INTERFACE_DISPATCH_STUB
